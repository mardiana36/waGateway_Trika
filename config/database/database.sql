...
CREATE TABLE
  IF NOT EXISTS `messages_in_group` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS `messages_in_personal` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE
  IF NOT EXISTS `messages_out_group` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
    `session_id` int (11) NOT NULL,
    ...
    `created_at` date NOT NULL DEFAULT current_timestamp(),
    PRIMARY KEY (`id`),
     KEY `sessions_idFKOG` (`session_id`),
    CONSTRAINT `sessions_idFKOG` FOREIGN KEY (`session_id`) REFERENCES `sessions` (`id`) ON DELETE CASCADE
  ) ENGINE = InnoDB;

CREATE TABLE
  IF NOT EXISTS `messages_out_personal` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
    `session_id` int (11) NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS `template_message` (
    `id` int (11) NOT NULL AUTO_INCREMENT,
    `session_id` int (11) NOT NULL,
    `name` varchar(100) NOT NULL,
